<!-- Sidebar -->
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3">Retail Management</div>
			</a>
			...
			<li class="nav-item active"><a class="nav-link"
				href="/admin/dashboard"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseTwo"> <i
						class="fa-brands fa-product-hunt"></i> <span>Products</span>
				</a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/pricing/create">Products pricing</a>
						<a class="collapse-item" href="/purchaseorder/create">Purchase Products</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseThree"> <i
						class="fa-brands fa-product-hunt"></i> <span>People</span>
				</a>
